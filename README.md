# ML-Food-Health-and-Association-Rules
Machine Learning project: decision tree, random forest, clustering on McDonald's nutrition data + association rules on store sales.
...
- . Association Rule Mining (Store Sales)
